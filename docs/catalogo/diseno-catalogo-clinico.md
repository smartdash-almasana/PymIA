<!--
FUENTE_ORIGINAL: docs/architecture/SYMPTOM_PATHOLOGY_CATALOG_DESIGN.md
ESTADO: normalizado_minimo
NORMALIZACION: removida sección "Próximo frente técnico sugerido" — contiene referencia a TS_026C_SYMPTOM_PATHOLOGY_CATALOG (task spec de factoría) y rutas app/catalogs/ irrelevantes para PymIA
-->
...
Este catálogo se ubica antes de `operational_conditions_catalog`.
...
Mitigación: todo entra como hipótesis investigable.

### 2. Preguntas excesivas
Mitigación: preguntas mínimas necesarias.
...
Mitigación: castellano operativo, dolores reales, evidencia concreta, skills accionables.

### 4. Datos pedidos sin explicación
Mitigación: explicar siempre para qué se pide la evidencia.
