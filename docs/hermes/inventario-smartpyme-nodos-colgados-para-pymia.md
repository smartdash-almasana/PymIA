...
| Alta | `BasicOperationalDiagnosticService` | `SmartPyme/app/services/basic_operational_diagnostic_service.py` | No encontrado en PymIA | Motor determinístico MVP con reglas explícitas de hallazgos operacionales; posible base de kernel diagnóstico. |
