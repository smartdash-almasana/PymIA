...
> SUPERSEDED_FOR_CURRENT_PRODUCT_STATE — conserva límites arquitectónicos válidos, pero su `NEXT_STEP` histórico no gobierna la continuidad actual. Ver `SERVICE_1_CURRENT_PRODUCT_STATE_V1.md`.
...
NEXT_STEP: HISTORICAL — superseded by SERVICE_1_CURRENT_PRODUCT_STATE_V1.md
```
