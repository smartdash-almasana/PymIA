...
```text
PymIA-Live/pymia/smartpyme/service_1_web_column_confirmation_intake_boundary_v1.py
```

Test file:

```text
PymIA-Live/tests/smartpyme/test_service_1_web_column_confirmation_intake_boundary_v1.py
```
