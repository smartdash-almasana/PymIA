...
# Add PymIA to sys.path for imports
TESTS_DIR = Path(__file__).resolve().parent.parent
PYMIA_ROOT = TESTS_DIR.parent
REPO_ROOT = PYMIA_ROOT
sys.path.insert(0, str(PYMIA_ROOT))
...
def test_does_not_import_forbidden_modules():
    ...
    module_path = PYMIA_ROOT / "pymia" / "smartpyme" / "service_1_xlsx_structure_v1.py"
