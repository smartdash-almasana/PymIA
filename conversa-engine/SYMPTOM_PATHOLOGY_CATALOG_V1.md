# SymptomPathologyCatalog V1

## Role

Static first catalog for mapping owner pain into operational symptoms, candidate pathologies, investigable hypotheses, required variables, required evidence and mayeutic questions.

## Rule

```text
Dolor del dueño no es diagnóstico.
Síntoma operativo no es patología confirmada.
Patología posible no es hallazgo.
Hipótesis no afirma: investiga.
```
...
get_blocking_criteria(symptom_id)
```

---

## Entry: sospecha_perdida_margen
...
## Entry: incertidumbre_costo_produccion
