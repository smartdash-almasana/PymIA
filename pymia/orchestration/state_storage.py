...
def save_state(
    ...
    state_dict = {
        ...
        "progressive_context": state.progressive_context,
    ...
    for line in reversed(lines):
        ...
        if state_dict.get("chat_id") == chat_id:
            ...
            return PymIAState(
                ...
                progressive_context=state_dict.get("progressive_context", {}),
                ...
                gate_verdict=state_dict.get("gate_verdict"),
                delivery_summary=state_dict.get("delivery_summary"),
                output_refs=state_dict.get("output_refs", []),
                findings_count=state_dict.get("findings_count", 0),
