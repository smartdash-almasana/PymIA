"""Resolve owner-confirmed normalized evidence for LIQ_002."""
...
SCHEMA_VERSION: Final[str] = "SERVICE_1_LIQ_002_NORMALIZED_EVIDENCE_V1"
...
def evaluate_liq_002_from_normalized_tables_v1(
    *, computation_plan: object, normalized_tables: object, column_refs: object
    ...
    for variable_name in _REQUIRED_VARIABLES:
        ...
        for row_index, row in enumerate(rows, start=1):
            ...
            if raw_value is None or (isinstance(raw_value, str) and not raw_value.strip()):
                continue
            value, value_error = _parse_nonnegative(raw_value)
            if value_error:
                errors.append(
    ...
    if errors:
        return _blocked(errors, aggregation={"sources": aggregation_sources})

    result = evaluate_liq_002_from_computation_plan_v1(
