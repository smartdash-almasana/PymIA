    ...
    return (
        ...
        Service1ColumnUnderstandingCorpusCaseV1(
            ...
            columns=(
                ...
                _col("iva", (21, 21), "number", ROLE_UNKNOWN, ROLE_UNKNOWN, must=True, dangerous=False),
        ...
        Service1ColumnUnderstandingCorpusCaseV1(
            ...
            columns=(
                ...
                _col("cobrado", (5000, 3200), "number", ROLE_UNKNOWN, ROLE_UNKNOWN, must=True, dangerous=True),
                _col("pendiente", (1200, 0), "number", ROLE_UNKNOWN, ROLE_UNKNOWN, must=True, dangerous=True),
        ...
        Service1ColumnUnderstandingCorpusCaseV1(
            ...
            columns=(
                ...
                _col("iva", (441, 1260), "number", ROLE_UNKNOWN, ROLE_UNKNOWN, must=True),
            ),
        ),
        Service1ColumnUnderstandingCorpusCaseV1(
            case_id="S1-CUE-006",
