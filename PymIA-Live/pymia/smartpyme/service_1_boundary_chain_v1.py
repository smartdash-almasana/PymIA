...
"""EXPERIMENTAL_FROZEN boundary chain for Service 1 contract audit.

This module is not a runtime pipeline, not an active Service 1 delivery lane,
and must not be expanded until a vendible Service 1 contract is closed first.
